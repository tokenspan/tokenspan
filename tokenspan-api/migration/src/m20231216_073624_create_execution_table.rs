...
impl MigrationTrait for Migration {
    async fn up(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        manager
            .create_type(
                Type::create()
                    .as_enum(ExecutionStatus::Table)
                    .values([ExecutionStatus::Success, ExecutionStatus::Failure])
                    .to_owned(),
            )
            .await?;
        ...
        manager
            .create_table(
                Table::create()
                    ...
                    .col(ColumnDef::new(Execution::Messages).json().not_null())
                    ...
                    .col(
                        ColumnDef::new(Execution::Status)
                            .enumeration(
    ...
    async fn down(&self, manager: &SchemaManager) -> Result<(), DbErr> {
        ...
        manager
            .drop_type(Type::drop().name(ExecutionStatus::Table).to_owned())
            .await
    }
}
